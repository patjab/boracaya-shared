...
export const isCancelled = (e: unknown): boolean => {
  const o = e as { name?: unknown; cancelled?: unknown } | null | undefined;
  return o?.name === 'AbortError' || o?.cancelled === true;
};
 ...
 */
export const isCancelledCall = (e: unknown, signal?: AbortSignal): boolean =>
  signal?.aborted === true || isCancelled(e);
