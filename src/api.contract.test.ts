...
describe('AdminEventApi contract', () => {
    const EXPECTED_EVENT_PATHS: Record<string, string> = {
        ...
        capacity: '/events/e-1/capacity',
        rsvps: '/events/e-1/rsvp',
        attendanceRemovals: '/events/e-1/attendance/removals',
        ...
        scrambleSend: '/events/e-1/scramble/send',
        ...
        draftMessage: '/events/e-1/draft-message',
