...
// RUNTIME from the page hostname — no per-bundler build flags. A page served
// from either test host (test.pdaboracay.com or test.boracaya.com, cdk#500
// rebrand) is the testing environment; everything else — prod, and
// Node/SSR/unit-test where `window` is absent — resolves prod.
//
...
exports.isTestEnv = typeof window !== 'undefined' &&
