 ...
 * not nest (cdk#1011).
 */
const fitsSimpleType = (field, value) => {
    var _a;
    switch (field.type) {
        case 'text':
        case 'multiline':
        ...
        case 'select':
            return typeof value === 'string' && ((_a = field.options) !== null && _a !== void 0 ? _a : []).includes(value);
        case 'date':
 ...
 */
const fitsEntry = (subFields, entry) => {
    if (entry === null || typeof entry !== 'object' || Array.isArray(entry))
        return false;
    const record = entry;
    if (!Object.values(record).every((v) => v === null || isPrimitive(v)))
        return false;
...
const fitsFieldType = (field, value) => {
    switch (field.type) {
        ...
        case 'repeatingGroup':
            return Array.isArray(value)
                && value.every((entry) => { var _a; return fitsEntry((_a = field.subFields) !== null && _a !== void 0 ? _a : [], entry); });
        default:
            return fitsSimpleType(field, value);
    }
};
exports.fitsFieldType = fitsFieldType;
