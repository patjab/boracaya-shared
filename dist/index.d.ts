...
export { currentUrl, currentPathname, queryParam, isLocalhost, viewportSnapshot, localFlag, replaceUrl, navigateTo, reloadPage, onWindowResize, onAuthChange, onGlobalKeydown, onBeforeUnload, } from './browser';
