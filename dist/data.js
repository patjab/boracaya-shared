...
exports.asArray = exports.clean = exports.isCancelled = exports.CancelledError = exports.ApiError = void 0;
...
Object.defineProperty(exports, "isCancelled", { enumerable: true, get: function () { return cancelled_1.isCancelled; } });
...
const expected = (err, method, url, status) => {
    (0, apiObserver_1.apiSucceeded)(method, url, status);
    return err;
};
...
const rejected = (e, err, method, url, startedAt, opts, res) => ((0, cancelled_1.isCancelledCall)(e, opts.signal)
...
async function sendJson(url, opts) {
    ...
    if (!res.ok) {
        ...
        const retryHeader = res.headers && typeof res.headers.get === 'function'
            ...
            : null;
        const err = new ApiError(label, serverMessage !== null && serverMessage !== void 0 ? serverMessage : `${label}: HTTP ${res.status}`, res.status, (_c = (0, security_1.retryAfterSeconds)(retryHeader)) !== null && _c !== void 0 ? _c : bodyRetryAfter);
