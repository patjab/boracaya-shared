...
export const isShellKey = (value) => typeof value === 'string' && SHELL_KEYS.includes(value);
export const STYLE_TIERS = ['generated', 'curated', 'content', 'brand'];
...
export const TYPE_VOICES = ['elegant', 'bold', 'playful', 'mono', 'script', 'clean'];
/**
