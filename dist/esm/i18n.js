import { asRecord, stringOr } from './untrusted.js';
/**
 ...
 */
export const lookup = (root, key) => stringOr(key.split('.').reduce((node, part) => asRecord(node)[part], root), key);
/**
 ...
 */
export const interpolate = (raw, params) => raw.replace(/\{(\w+)\}/g, (placeholder, name) => {
