...
export { currentUrl, currentPathname, queryParam, isLocalhost, viewportSnapshot, localFlag, replaceUrl, navigateTo, reloadPage, onWindowResize, onAuthChange, onGlobalKeydown, onBeforeUnload, onUncaughtErrors, onDocumentClick, pageTelemetryContext, } from './browser.js';
...
export { ensureGuestToken, hasGuestSession, guestAuthHeaders, guestLinkedEmail, clearGuestToken, claimIdentity, loginNoEvent, unlinkIdentity, guestTokenExpiresInSeconds, exchangeInvitationToken, exchangeLegacyInvite, guestSubjectFromToken, } from './guestAuth.js';
