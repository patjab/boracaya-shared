...
export async function sendJson(url, opts) {
    ...
    if (!res.ok) {
        ...
        const retryHeader = res.headers && typeof res.headers.get === 'function'
            ...
            : null;
        throw new ApiError(label, serverMessage !== null && serverMessage !== void 0 ? serverMessage : `${label}: HTTP ${res.status}`, res.status, (_c = parseRetryAfterSeconds(retryHeader)) !== null && _c !== void 0 ? _c : bodyRetryAfter);
    }
    if (!text.trim())
        return undefined;
    try {
